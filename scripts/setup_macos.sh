...
#
# Pretty much all of these files/values were pulled from the following sources:
...
########################################
# Keyboard, Touchpad, Mouse, Bluetooth #
########################################
...
printf '\n<<< Please restart device to ensure changes take affect >>>\n'
